...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <p>
        <h2>
            Giving project reviews / feedback

        </h2>
        The availability of the feedback option varies for fixed-price and hourly projects. Once submitted, your feedback is final and cannot be changed.
       ...
       <h3>Fixed-Price Projects</h3> 
        ...
        <h3>Hourly Projects</h3>
        
         
        
        The feedback option is available every time a weekly automatic Milestone Payment for an hourly project is paid. Once the project is marked as Complete, feedback can be submitted for the entire project. All feedback for an hourly project - for the paid Milestone Payments and for the entire project - will be combined and will be displayed on your profile as one.
      </p>
