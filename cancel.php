...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
     ...
     <h3>To cancel orders that aren't dispatched yet:</h3> 

    1.Go to Your Orders <br>
    2.Select the item you want to cancel and click <br> 3.Cancel items <br>
    4.Provide reasons for cancellation (optional) <br>
    5.Click on Cancel Checked Items <br>

   <h4>Note:</h4>  Your order will be cancelled instantly and a refund will be processed to your original payment method, if the payment was already made. Learn more about refund processing timelines here.
...
To cancel the order that is shipped directly by the Seller and not by Amazon:

    Go to Your Orders
    Please contact the seller to Request Cancellation option
